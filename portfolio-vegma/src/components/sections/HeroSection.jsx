...
const HeroSection = () => {
  return (
    <motion.div
      className="w-full h-fit bg-gradient-to-l from-primary via-primary to-primary md:from-primary md:via-primary md:to-blue-950 px-3 sm:px-20 py-20 sm:py-40"
